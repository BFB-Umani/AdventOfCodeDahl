...
func main() {
	...
	for i := 0; i < len(moves); i++ {
		...
		var amountToMove, _ = strconv.Atoi(instructions[1])
		var cratesToMove = cratesMap[instructions[3]][len(cratesMap[instructions[3]])-amountToMove:]
		cratesMap[instructions[5]] = append(cratesMap[instructions[5]], cratesToMove...)
		cratesMap[instructions[3]] = cratesMap[instructions[3]][:len(cratesMap[instructions[3]])-amountToMove]
	}
